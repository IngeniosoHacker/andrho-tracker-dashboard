...
// reactbits.dev "InfiniteMenu" component — a WebGL2 sphere of draggable tiles.
// Ported from the project's TypeScript source to plain JS for this Vite/JS app.
...
export default function InfiniteMenu({ items = [], scale = 1.0, backgroundColor = 'transparent' }) {
